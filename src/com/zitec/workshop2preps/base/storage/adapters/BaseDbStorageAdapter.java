...
import com.zitec.workshop2preps.utils.DatabaseHelper;
import com.zitec.workshop2preps.utils.VersionUtils;
...
public class BaseDbStorageAdapter extends BaseStorageAdapter {
	...
	public BaseDbStorageAdapter(Context ctx) throws NameNotFoundException {
		...
		if(BaseDbStorageAdapter.dbHelper == null){
			BaseDbStorageAdapter.dbHelper = new DatabaseHelper(ctx.getApplicationContext(), null, VersionUtils.getVersionCode(ctx));
		}
